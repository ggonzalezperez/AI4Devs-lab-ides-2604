---
name: code-auditing
description: Use when performing comprehensive code quality audits, security vulnerability assessments, technical debt identification, or pre-release code reviews.
version: 1.0.0
---
