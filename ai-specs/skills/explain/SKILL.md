---
name: explain
description: Use when the user asks a question that reveals a skill or concept gap — to teach the underlying concepts with clear mental models, not just answer the surface question.
author: LIDR.co
version: 1.0.0
---
